...
{
	template<>
	inline void swap<math::Vector2>(math::Vector2& one, math::Vector2& two)
    noexcept(is_nothrow_move_constructible<math::Vector2>::value && is_nothrow_move_assignable<math::Vector2>::value)
	{
		one.swap(two);
	}
}
