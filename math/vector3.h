...
{
	template<>
    inline void swap<math::Vector3>(math::Vector3& one, math::Vector3& two)
    noexcept(is_nothrow_move_constructible<math::Vector3>::value && is_nothrow_move_assignable<math::Vector3>::value)
	{
		one.swap(two);
	}
}
