...
Vector4 math::operator * (float scalar, const Vector4& vector)
{
...
std::ostream& math::operator<<(std::ostream& output, const Vector4& p)
{
	return output << "(" << p.x() << "," << p.y() << "," << p.z() << "," << p.w() << ")";
}

Vector4 math::saturate(const Vector4& vector)
{
	Vector4 v;
