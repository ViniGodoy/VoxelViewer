...
{
	template<>
	inline void swap<math::Vector4>(math::Vector4& one, math::Vector4& two)
    noexcept( is_nothrow_move_constructible<math::Vector4>::value && is_nothrow_move_assignable<math::Vector4>::value )
	{
		one.swap(two);
	}
}
